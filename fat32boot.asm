...
;读取 loader.bin 文件 写入 0x100:0000 处
;最大支持1M 写入1M 的大小 实际上 引导程序用不到这么多
...
Label_Goto_Next_Sector_In_Root_Dir:
	...
	jmp	Lable_Search_In_Root_Dir_Begin
     ...
     ClusterLBA:
          ...
          ret
     LoaderESAddress  dw 0x9000
     Sectoroffset   dw 0x100
     Fatcluster dd 0x00
     NoLoaderMessage:	db	"X"
     SectorNo db 0x00
     LoaderFileName: db	"LOADER  BIN",0;寻找的 文件名 loader.bin
     msgProgress db ".", 0x00
